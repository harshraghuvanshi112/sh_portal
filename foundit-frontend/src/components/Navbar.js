    ...
    <>
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        ...
        <div className="container-fluid">
          <Link className="navbar-brand  text-white fw-bolder fs-4" to="/">
            shPortal
          </Link>
          <button
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item d-flex flex-row">
                <Link className="nav-link  text-muted p" to="search">
                  <i className="bi bi-search me-1"></i>Search
                </Link>
              </li>
              <li className="nav-item d-flex flex-row">
                <Link className="nav-link  text-muted p" to="placement">
                  Placement
                </Link>
              </li>
              <li className="nav-item d-flex flex-row">
                <Link className="nav-link  text-muted p" to="academic">
                  Academic
                </Link>
              </li>
              <li className="nav-item d-flex flex-row">
              ...
              <li className="nav-item d-flex flex-row">
                <Link className="nav-link  text-muted p" to="puzzle">
                  Puzzle
                </Link>
              </li>
              ...
              {localStorage.getItem("auth_token") &&
                ...
                verified && (
                  <li className="nav-item d-flex flex-row">
                    <Link
                      className="nav-link  text-muted p"
                      to="admin/allItems"
                    >
                      Admin
                    </Link>
            ...
            {localStorage.getItem("auth_token") && verified ? (
              ...
              <div className="d-flex">
                ...
                <Link className="btn btn-outline-primary ms-3" to="signup">
                  Signup
                </Link>
              </div>
            )}
